...
Mode = 'Train'
DEBUG = 'True'
DATASET = 'PEMSD3'      #PEMSD4 or PEMSD8 or PEMSD7 OR PEMSD3
DEVICE = 'cuda:0'
MODEL = 'H2STGCN'
...
def masked_mae_loss(scaler, mask_value):  # default value: mask_value=0.
...
if args.mode == 'Train':
    ...
    model.load_state_dict(torch.load('../pre-trained/{}.pth'.format(args.dataset))) #将预训练的参数权重加载到新的模型中
