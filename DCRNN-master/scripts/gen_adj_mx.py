...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensor_ids_filename', type=str, default='../PEMS03.txt',
                        help='File containing sensor ids separated by comma.')
    parser.add_argument('--distances_filename', type=str, default='../PEMS03.csv',
    ...
    parser.add_argument('--output_pkl_filename', type=str, default='../data/sensor_graph/pems03t.pkl',
