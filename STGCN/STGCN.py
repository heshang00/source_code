...
parser.add_argument("--data_name", type=str, default=8,
                    help="the number of data documents [3/8/4/7]", required=False)
parser.add_argument('--num_point', type=int, default=170, help='road Point Number [358/170/307/883] ', required=False)

# decay rate of learning rate 学习率的衰减
parser.add_argument('--decay', type=float, default=0.97, help='decay rate of learning rate [0.97/0.97/0.92]')
